      ...
      <div className="bg-white rounded-3xl p-4 shadow-sm border border-slate-100 flex flex-col gap-4 h-full min-h-full overflow-hidden min-h-0">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 flex-shrink-0">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="relative">
              <select
                ...
                className="form-input form-select text-slate-700 bg-white font-bold pr-9 border-slate-200 hover:ring-slate-350 transition text-xs py-2 shadow-2xs rounded-xl cursor-pointer"
                style={{ width: '160px' }}
              >
            ...
            <div className="flex items-center gap-1 bg-white p-0.5 rounded-xl ring-1 ring-slate-200 ring-inset border-0 shadow-2xs">
              <button
              ...
              {showDatePicker && (
                <div className="absolute top-36 z-50 bg-white p-3 ring-1 ring-slate-200 ring-inset border-0 rounded-xl shadow-xl flex flex-col gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* View Tab Selector */}
            <div className="bg-slate-100 p-0.5 rounded-xl flex ring-1 ring-slate-200 ring-inset border-0 shadow-3xs">
              {['Month', 'Day', 'Week'].map((tab) => (
                <button
                  key={tab}
                  className={`text-xs py-1.5 px-3.5 rounded-lg font-bold transition flex-shrink-0 cursor-pointer ${scheduleView === tab
                      ? 'bg-white text-primary-700 shadow-2xs ring-1 ring-slate-200 ring-inset border-0/40'
            ...
            {/* Action buttons */}
            <button
              className="btn-secondary text-xs py-2 px-3.5 shadow-2xs flex items-center gap-1.5 font-bold text-slate-600 rounded-xl ring-1 ring-slate-200 ring-inset border-0 cursor-pointer"
              onClick={() => setShowDatePicker(!showDatePicker)}
            >
              <Filter size={13} />
              <span>Filter</span>
            ...
            <button
              className="btn-secondary text-xs p-2.5 shadow-2xs text-slate-600 rounded-xl ring-1 ring-slate-200 ring-inset border-0 cursor-pointer"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 flex-grow min-h-0 overflow-hidden">
          ...
          <div className="lg:col-span-9 flex flex-col gap-5 h-full overflow-hidden">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2.5 flex-shrink-0 pt-1">

              {/* Total Appointments */}
              <div className="relative overflow-hidden bg-white ring-1 ring-slate-200 ring-inset border-0 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 pt-3 px-3.5 pb-1 flex flex-col justify-between h-[105px] group hover:ring-blue-400 hover:-translate-y-0.5 transition-all duration-300">
              ...
              {/* Completed */}
              <div className="relative overflow-hidden bg-white ring-1 ring-slate-200 ring-inset border-0 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 pt-3 px-3.5 pb-1 flex flex-col justify-between h-[105px] group hover:ring-emerald-400 hover:-translate-y-0.5 transition-all duration-300">
                <div className="flex items-start gap-2.5">
              ...
              {/* Waiting */}
              <div className="relative overflow-hidden bg-white ring-1 ring-slate-200 ring-inset border-0 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 pt-3 px-3.5 pb-1 flex flex-col justify-between h-[105px] group hover:ring-amber-400 hover:-translate-y-0.5 transition-all duration-300">
                <div className="flex items-start gap-2.5">
              ...
              {/* Urgent */}
              <div className="relative overflow-hidden bg-white ring-1 ring-slate-200 ring-inset border-0 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 pt-3 px-3.5 pb-1 flex flex-col justify-between h-[105px] group hover:ring-rose-400 hover:-translate-y-0.5 transition-all duration-300">
                <div className="flex items-start gap-2.5">
              ...
              {/* No Shows */}
              <div className="relative overflow-hidden bg-white ring-1 ring-slate-200 ring-inset border-0 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 pt-3 px-3.5 pb-1 flex flex-col justify-between h-[105px] group hover:ring-purple-400 hover:-translate-y-0.5 transition-all duration-300">
                <div className="flex items-start gap-2.5">
            ...
            <div className="flex flex-col bg-white ring-1 ring-slate-200 ring-inset border-0/90 rounded-2xl overflow-hidden flex-grow shadow-md hover:shadow-lg p-3.5 min-h-0">
                        ...
                        {calendarGrid.map((cell, idx) => {
                          ...
                          return (
                            <div
                              ...
                              className={`border rounded-xl transition duration-150 cursor-pointer min-h-0 h-full hover:ring-primary-400 hover:shadow-2xs ${isSelected
                            ...
                            >
                              <div className="flex flex-col h-full justify-between p-3 select-none">
                                ...
                                <div className="flex flex-col items-start leading-none">
                                  {isTodayVal ? (
                                    <span className="text-[10px] font-extrabold bg-primary text-white w-5 h-5 rounded-full flex items-center justify-center shadow-md hover:shadow-lg flex-shrink-0">
                                      {cell.dayNum}
                                    </span>
                                  ) : (
                        ...
                        {timelineItems.map((item, idx) => {
                          ...
                          if (item.type === 'lunch') {
                            return (
                              <div key="lunch" className="relative flex min-h-[48px] items-center">
                                ...
                                {/* Connect dot */}
                                <div className="absolute -left-[30px] w-2 h-2 rounded-full bg-slate-300 border-2 border-white shadow-md hover:shadow-lg"></div>
                          ...
                          return (
                            <div key={apt.id} className="relative flex items-start min-h-[92px]">
                              ...
                              <div className={`absolute -left-[30px] w-2 h-2 rounded-full bg-white border-2 ${apt.status === 'Completed' ? 'border-emerald-500' :
                                    ...
                                    apt.status === 'Waiting' ? 'border-amber-500' :
                                      apt.status === 'Urgent' ? 'border-rose-500' :
                                        apt.status === 'No Show' ? 'border-purple-400' :
                                          'border-slate-300'
                                } shadow-md hover:shadow-lg z-10 mt-3`}></div>

                              {/* Interactive Card Body */}
                              <div className={`w-full rounded-2xl p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 transition shadow-md hover:shadow-lg border-l-4 ${borderClass} ${cardBgClass}`}>
                                ...
                                <div className="flex items-center justify-between sm:justify-end gap-3 flex-shrink-0">
                                  ...
                                  <div className="flex items-center gap-2">
                                    <span className={`badge text-[9.5px] py-0.5 px-2.5 flex items-center gap-1 rounded-full ${apt.status === 'Completed' ? 'badge-green' :
                                      ...
                                      <span className={`w-1 h-1 rounded-full ${apt.status === 'Completed' ? 'bg-green-600' :
                                    ...
                                    <div className="relative">
                                      ...
                                      {activeMenuId === apt.id && (
                                        <div
                                          ref={menuRef}
                                          className="absolute right-0 mt-1 w-36 bg-white ring-1 ring-slate-200 ring-inset border-0 rounded-lg shadow-xl py-1 z-40 text-xs font-semibold"
                                        >
                                          <button
                    ...
                    <div className="grid grid-cols-7 gap-3 flex-1 overflow-y-auto min-w-[750px]">
                      {Array.from({ length: 7 }).map((_, i) => {
                        ...
                        return (
                          <div
                            key={i}
                            className={`border rounded-xl p-3 flex flex-col justify-between hover:ring-primary-400 transition cursor-pointer min-h-[200px] ${isDaySelected ? 'border-primary bg-primary-50/10 ring-1 ring-primary' : 'border-slate-200 bg-white'
                              }`}
                            onClick={() => {
          ...
          <div className="lg:col-span-3 flex flex-col gap-5 h-full overflow-hidden">
            ...
            <div className="section-card p-4.5 bg-white ring-1 ring-slate-200 ring-inset border-0 rounded-2xl shadow-md hover:shadow-lg flex-shrink-0">
            ...
            <div className="section-card p-4.5 bg-white ring-1 ring-slate-200 ring-inset border-0 rounded-2xl shadow-md hover:shadow-lg flex-grow min-h-0 flex flex-col">
